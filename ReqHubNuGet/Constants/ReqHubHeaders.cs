...
namespace ReqHub
{
    public static class ReqHubHeaders
    {
        public const string MerchantTokenHeader = "MerchantToken";

        public const string MerchantPublicKeyHeader = "MerchantKey";

        public const string MerchantTimestampHeader = "MerchantTimestamp";
